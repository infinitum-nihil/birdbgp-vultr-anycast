...
function execute_bird_command($command) {
...
if ($cmd) {
    ...
    if ($bird_cmd) {
        ...
        echo "<pre>";
        $output = execute_bird_command($bird_cmd);
        echo htmlspecialchars($output);
        echo "</pre>";
    }
} else {
?>
        <h2>Welcome to the BGP Looking Glass</h2>
